...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wfpdocs_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'wfpdocs', ['Category'])

        # Adding model 'WFPDocument'
        db.create_table(u'wfpdocs_wfpdocument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('orientation', self.gf('django.db.models.fields.IntegerField')()),
            ('page_format', self.gf('django.db.models.fields.IntegerField')()),
            ('document', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['documents.Document'], unique=True)),
        ))
        db.send_create_signal(u'wfpdocs', ['WFPDocument'])

        # Adding M2M table for field categories on 'WFPDocument'
        db.create_table(u'wfpdocs_wfpdocument_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wfpdocument', models.ForeignKey(orm[u'wfpdocs.wfpdocument'], null=False)),
            ('category', models.ForeignKey(orm[u'wfpdocs.category'], null=False))
        ))
        db.create_unique(u'wfpdocs_wfpdocument_categories', ['wfpdocument_id', 'category_id'])


    def backwards(self, orm):
        
        # Deleting model 'Category'
        db.delete_table(u'wfpdocs_category')

        # Deleting model 'WFPDocument'
        db.delete_table(u'wfpdocs_wfpdocument')

        # Removing M2M table for field categories on 'WFPDocument'
        db.delete_table('wfpdocs_wfpdocument_categories')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 11, 16, 1, 59, 286884)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 11, 16, 1, 59, 292908)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 11, 16, 1, 59, 292485)'}),
        ...
        u'wfpdocs.wfpdocument': {
            'Meta': {'object_name': 'WFPDocument'},
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['wfpdocs.Category']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'page_format': ('django.db.models.fields.IntegerField', [], {}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }

    complete_apps = ['wfpdocs']
