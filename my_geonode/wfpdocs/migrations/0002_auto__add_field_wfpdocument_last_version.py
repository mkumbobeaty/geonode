...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WFPDocument.last_version'
        db.add_column(u'wfpdocs_wfpdocument', 'last_version', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WFPDocument.last_version'
        db.delete_column(u'wfpdocs_wfpdocument', 'last_version')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 11, 16, 2, 42, 513029)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 11, 16, 2, 42, 517872)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 11, 16, 2, 42, 517431)'}),
        ...
        u'wfpdocs.wfpdocument': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_version': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
